...
from ..pipelines.treccast2020 import TRECCast2020Configuration, TRECCast2020Experiment

logging.basicConfig(level=logging.INFO)

@define(kw_only=True)
class SPLADETRECCast2020Configuration(TRECCast2020Configuration):
    # Nothing new for now
    pass

class SPLADETRECCast2020Experiment(TRECCast2020Experiment):
    """Base class for SPLADE experiments based on TREC CAST 2020"""

    cfg: SPLADETRECCast2020Configuration
    ...
    def __init__(self, xp: experiment, cfg: SPLADETRECCast2020Configuration):
