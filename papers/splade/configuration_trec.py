...
from .pipeline_trec import SPLADETRECCast2020Configuration
...
@define(kw_only=True)
class SPLADE_TREC(SPLADETRECCast2020Configuration):
    
    indexation: Indexation = Factory(Indexation)
    learner: Learner_TREC = Factory(Learner_TREC)
